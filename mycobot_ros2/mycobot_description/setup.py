...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/urdf'+'/mycobot_280_muse_pi', glob("urdf/mycobot_280_muse_pi/*")),
        ('share/' + package_name + '/urdf'+'/mycobot_280_rdkx5', glob("urdf/mycobot_280_rdkx5/*")),

        # NEW: Install top-level .urdf / .xacro files in urdf/ folder (like mycobot_gripper.urdf.xacro)
        ('share/' + package_name + '/urdf', glob("urdf/*.urdf*")),

        # NEW: Install everything inside adaptive_gripper
